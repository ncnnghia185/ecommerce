...
def get_order_from_api(request, order_code):
    api_url = 'https://dev-online-gateway.ghn.vn/shiip/public-api/v2/shipping-order/detail'
    api_key = 'd8574292-4ab3-11ee-b1d4-92b443b7a897'
    headers = {
    ...
    try:
        ...
        return render(request,'ecom/admin/error.html',({'error_message': str(e)}))
...
def home_view(request):
    ...
    return render(request,'ecom/core/index.html',{'products':products,'product_count_in_cart':product_count_in_cart})

#Detail product
def detail(request,pk):
    product = get_object_or_404(models.Product, id=pk)
    return render(request, 'ecom/core/detailprod.html', {'product': product})
...
def customer_home_view(request):
    ...
    if 'product_ids' in request.COOKIES:
        ...
        product_count_in_cart=0
    return render(request,'ecom/user/customer_home.html',{'products':products,'product_count_in_cart':product_count_in_cart})
